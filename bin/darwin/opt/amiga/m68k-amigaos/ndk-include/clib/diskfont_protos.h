...
LONG  __stdargs AvailFonts( STRPTR buffer, LONG bufBytes, LONG flags );
/*--- functions in V34 or higher (Release 1.3) ---*/
struct FontContentsHeader * __stdargs NewFontContents( BPTR fontsLock, STRPTR fontName );
...
VOID  __stdargs SetDiskFontCtrlA( struct TagItem *taglist );
