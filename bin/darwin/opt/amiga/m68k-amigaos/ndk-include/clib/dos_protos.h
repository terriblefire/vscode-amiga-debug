...
LONG  __stdargs Write( BPTR file, CONST APTR buffer, LONG length );
...
BOOL  __stdargs LockRecords( struct RecordLock *recArray, ULONG timeout );
BOOL  __stdargs UnLockRecord( BPTR fh, ULONG offset, ULONG length );
BOOL  __stdargs UnLockRecords( struct RecordLock *recArray );
/*	Buffered File I/O */
...
LONG  __stdargs FWrite( BPTR fh, CONST APTR block, ULONG blocklen, ULONG number );
...
LONG  __stdargs VFPrintf( BPTR fh, CONST_STRPTR format, CONST APTR argarray );
...
BOOL  __stdargs Fault( LONG code, STRPTR header, STRPTR buffer, LONG len );
...
struct MsgPort * __stdargs SetConsoleTask( CONST struct MsgPort *task );
struct MsgPort * __stdargs GetFileSysTask( VOID );
struct MsgPort * __stdargs SetFileSysTask( CONST struct MsgPort *task );
STRPTR  __stdargs GetArgStr( VOID );
BOOL  __stdargs SetArgStr( CONST_STRPTR string );
...
BOOL  __stdargs InternalUnLoadSeg( BPTR seglist, VOID (*CONST freefunc)() );
...
LONG  __stdargs ParsePattern( CONST_STRPTR pat, STRPTR buf, LONG buflen );
BOOL  __stdargs MatchPattern( CONST_STRPTR pat, STRPTR str );
...
LONG  __stdargs VPrintf( CONST_STRPTR format, CONST APTR argarray );
LONG  __stdargs Printf( CONST_STRPTR format, ... );
/* these were unimplemented until dos 36.147 */
LONG  __stdargs ParsePatternNoCase( CONST_STRPTR pat, UBYTE *buf, LONG buflen );
BOOL  __stdargs MatchPatternNoCase( CONST_STRPTR pat, STRPTR str );
