...
VOID  __stdargs DrawImage( struct RastPort *rp, struct Image *image, LONG leftOffset, LONG topOffset );
...
LONG  __stdargs EasyRequestArgs( struct Window *window, CONST struct EasyStruct *easyStruct, ULONG *idcmpPtr, CONST APTR args );
LONG  __stdargs EasyRequest( struct Window *window, CONST struct EasyStruct *easyStruct, ULONG *idcmpPtr, ... );
struct Window * __stdargs BuildEasyRequestArgs( struct Window *window, CONST struct EasyStruct *easyStruct, ULONG idcmp, CONST APTR args );
...
/*	new Image functions */
VOID  __stdargs DrawImageState( struct RastPort *rp, struct Image *image, LONG leftOffset, LONG topOffset, ULONG state, CONST struct DrawInfo *drawInfo );
BOOL  __stdargs PointInImage( ULONG point, struct Image *image );
VOID  __stdargs EraseImage( struct RastPort *rp, struct Image *image, LONG leftOffset, LONG topOffset );
...
APTR  __stdargs NextObject( APTR objectPtrPtr );
