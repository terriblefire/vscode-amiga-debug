...
struct Region *   __stdargs InstallClipRegion( struct Layer *layer, CONST struct Region *region );
...
struct Hook *   __stdargs InstallLayerInfoHook( struct Layer_Info *li, CONST struct Hook *hook );
