...
#endif
#ifdef GENERATOR_FILE
extern const char *string_bbb_opts;
#else
  const char *x_string_bbb_opts;
#define string_bbb_opts global_options.x_string_bbb_opts
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_loop_size_optimize;
#else
  int x_flag_loop_size_optimize;
#define flag_loop_size_optimize global_options.x_flag_loop_size_optimize
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_no_truncz_same_mode;
#else
  int x_flag_no_truncz_same_mode;
#define flag_no_truncz_same_mode global_options.x_flag_no_truncz_same_mode
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_prune_stack_vars;
#else
  int x_flag_prune_stack_vars;
#define flag_prune_stack_vars global_options.x_flag_prune_stack_vars
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern const char *amigaos_crt;
#else
  const char *x_amigaos_crt;
#define amigaos_crt global_options.x_amigaos_crt
#endif
#ifdef GENERATOR_FILE
extern int amigaos_regparm;
#else
  int x_amigaos_regparm;
#define amigaos_regparm global_options.x_amigaos_regparm
#endif
#ifdef GENERATOR_FILE
extern int amigaos_retfp0;
#else
  int x_amigaos_retfp0;
#define amigaos_retfp0 global_options.x_amigaos_retfp0
#endif
#ifdef GENERATOR_FILE
extern int sas_regparm;
#else
  int x_sas_regparm;
#define sas_regparm global_options.x_sas_regparm
#endif
#ifdef GENERATOR_FILE
extern int flag_smallcode;
#else
  int x_flag_smallcode;
#define flag_smallcode global_options.x_flag_smallcode
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_resident;
#else
  int x_flag_resident;
#define flag_resident global_options.x_flag_resident
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_noixemul;
#define x_VAR_noixemul do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_ramiga_dev;
#define x_VAR_ramiga_dev do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_ramiga_lib;
#define x_VAR_ramiga_lib do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_ramiga_libr;
#define x_VAR_ramiga_libr do_not_use
#endif
#ifndef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_flag_loop_size_optimize;
...
enum opt_code
{
  ...
  OPT_fbaserel = 532,                        /* -fbaserel */
  OPT_fbaserel32 = 533,                      /* -fbaserel32 */
  OPT_fbbb_ = 534,                           /* -fbbb= */
  ...
  OPT_floop_size_optimize = 811,             /* -floop-size-optimize */
  ...
  OPT_fno_truncz_same_mode = 849,            /* -fno-truncz-same-mode */
  ...
  OPT_fprune_stack_vars = 914,               /* -fprune-stack-vars */
  OPT_frandom_seed = 915,                    /* -frandom-seed */
  OPT_frandom_seed_ = 916,                   /* -frandom-seed= */
  OPT_frange_check = 917,                    /* -frange-check */
  OPT_freal_4_real_10 = 918,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 919,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 920,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 921,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 922,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 923,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 924,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 925,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 926,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 927,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 928,                /* -frecord-marker=8 */
  OPT_frecursive = 929,                      /* -frecursive */
  OPT_freduced_reflection = 930,             /* -freduced-reflection */
  OPT_free = 931,                            /* -free */
  OPT_freg_struct_return = 932,              /* -freg-struct-return */
  /* OPT_fregmove = 933, */                  /* -fregmove */
  OPT_frename_registers = 934,               /* -frename-registers */
  OPT_freorder_blocks = 935,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 936,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 937,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 938,              /* -freorder-functions */
  OPT_frepack_arrays = 939,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 940,           /* -freplace-objc-classes */
  OPT_frepo = 941,                           /* -frepo */
  OPT_freport_bug = 942,                     /* -freport-bug */
  OPT_frequire_return_statement = 943,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 944,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 945, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 946,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 947,                    /* -fresolution= */
  OPT_frounding_math = 948,                  /* -frounding-math */
  OPT_frtti = 949,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 950,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 951,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 952,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 953,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 954,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 955,                      /* -fsanitize= */
  OPT_fsaw_java_file = 956,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 957,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 958,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 959,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 960,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 961,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 962,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 963,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 964,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 965,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 966,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 967,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 968,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 969,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 970,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 971,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 972,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 973,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 974, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 975,                /* -fschedule-fusion */
  OPT_fschedule_insns = 976,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 977,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 978,              /* -fsecond-underscore */
  OPT_fsection_anchors = 979,                /* -fsection-anchors */
  /* OPT_fsee = 980, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 981,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 982,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 983, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 984,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 985,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 986,         /* -fsemantic-interposition */
  OPT_fshort_enums = 987,                    /* -fshort-enums */
  OPT_fshort_wchar = 988,                    /* -fshort-wchar */
  OPT_fshow_column = 989,                    /* -fshow-column */
  OPT_fshrink_wrap = 990,                    /* -fshrink-wrap */
  OPT_fsign_zero = 991,                      /* -fsign-zero */
  OPT_fsignaling_nans = 992,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 993,               /* -fsigned-bitfields */
  OPT_fsigned_char = 994,                    /* -fsigned-char */
  OPT_fsigned_zeros = 995,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 996,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 997,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 998,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 999,               /* -fsource-filename= */
  OPT_fsource_ = 1000,                       /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 1001,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 1002,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1003,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1004,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1005, */                /* -fsquangle */
  OPT_fssa_backprop = 1006,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1007,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1008,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1009,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1010, */             /* -fstack-check */
  OPT_fstack_check_ = 1011,                  /* -fstack-check= */
  OPT_fstack_limit = 1012,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1013,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1014,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1015,               /* -fstack-protector */
  OPT_fstack_protector_all = 1016,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1017,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1018,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1019,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1020,                   /* -fstack-usage */
  OPT_fstats = 1021,                         /* -fstats */
  OPT_fstdarg_opt = 1022,                    /* -fstdarg-opt */
  OPT_fstore_check = 1023,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1024, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1025,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1026,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1027,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1028, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1029,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1030,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1031,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1032,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1033, */             /* -ftarget-help */
  OPT_ftarget_ = 1034,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1035,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1036, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1037,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1038,                 /* -ftest-coverage */
  ...
  OPT_fuse_atomic_builtins = 1106,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1107,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1108,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1109,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1110,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1111,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1112,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1113,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1114,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1115,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1116,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1117,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1118,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1119, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1120,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1121,                   /* -fverbose-asm */
  /* OPT_fversion = 1122, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1123,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1124,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1125,                   /* -fvisibility= */
  OPT_fvpt = 1126,                           /* -fvpt */
  /* OPT_fvtable_gc = 1127, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1128, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1129,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1130,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1131,                     /* -fvtv-debug */
  OPT_fweak = 1132,                          /* -fweak */
  OPT_fweb = 1133,                           /* -fweb */
  /* OPT_fwhole_file = 1134, */              /* -fwhole-file */
  OPT_fwhole_program = 1135,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1136,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1137,             /* -fworking-directory */
  OPT_fwpa = 1138,                           /* -fwpa */
  OPT_fwpa_ = 1139,                          /* -fwpa= */
  OPT_fwrapv = 1140,                         /* -fwrapv */
  ...
  OPT_gnat = 1153,                           /* -gnat */
  OPT_gnatO = 1154,                          /* -gnatO */
  OPT_gno_pubnames = 1155,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1156,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1157,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1158,               /* -gno-strict-dwarf */
  ...
  OPT_gstrict_dwarf = 1164,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1165,                        /* -gtoggle */
  OPT_gvms = 1166,                           /* -gvms */
  OPT_gxcoff = 1167,                         /* -gxcoff */
  OPT_gxcoff_ = 1168,                        /* -gxcoff+ */
  OPT_gz = 1169,                             /* -gz */
  OPT_gz_ = 1170,                            /* -gz= */
  OPT_h = 1171,                              /* -h */
  OPT_idirafter = 1172,                      /* -idirafter */
  OPT_imacros = 1173,                        /* -imacros */
  OPT_imultiarch = 1174,                     /* -imultiarch */
  OPT_imultilib = 1175,                      /* -imultilib */
  OPT_include = 1176,                        /* -include */
  OPT_iplugindir_ = 1177,                    /* -iplugindir= */
  OPT_iprefix = 1178,                        /* -iprefix */
  OPT_iquote = 1179,                         /* -iquote */
  OPT_isysroot = 1180,                       /* -isysroot */
  OPT_isystem = 1181,                        /* -isystem */
  OPT_iwithprefix = 1182,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1183,              /* -iwithprefixbefore */
  OPT_k8 = 1184,                             /* -k8 */
  OPT_l = 1185,                              /* -l */
  OPT_lang_asm = 1186,                       /* -lang-asm */
  /* OPT_m5200 = 1187, */                    /* -m5200 */
  /* OPT_m5206e = 1188, */                   /* -m5206e */
  /* OPT_m528x = 1189, */                    /* -m528x */
  /* OPT_m5307 = 1190, */                    /* -m5307 */
  /* OPT_m5407 = 1191, */                    /* -m5407 */
  /* OPT_m68000 = 1192, */                   /* -m68000 */
  /* OPT_m68010 = 1193, */                   /* -m68010 */
  /* OPT_m68020 = 1194, */                   /* -m68020 */
  OPT_m68020_40 = 1195,                      /* -m68020-40 */
  OPT_m68020_60 = 1196,                      /* -m68020-60 */
  /* OPT_m68030 = 1197, */                   /* -m68030 */
  /* OPT_m68040 = 1198, */                   /* -m68040 */
  /* OPT_m68060 = 1199, */                   /* -m68060 */
  /* OPT_m68080 = 1200, */                   /* -m68080 */
  /* OPT_m68302 = 1201, */                   /* -m68302 */
  /* OPT_m68332 = 1202, */                   /* -m68332 */
  OPT_m68851 = 1203,                         /* -m68851 */
  OPT_m68881 = 1204,                         /* -m68881 */
  OPT_malign_int = 1205,                     /* -malign-int */
  OPT_malways_restore_a4 = 1206,             /* -malways-restore-a4 */
  OPT_march_ = 1207,                         /* -march= */
  OPT_mbitfield = 1208,                      /* -mbitfield */
  /* OPT_mc68000 = 1209, */                  /* -mc68000 */
  /* OPT_mc68020 = 1210, */                  /* -mc68020 */
  /* OPT_mcfv4e = 1211, */                   /* -mcfv4e */
  /* OPT_mcpu32 = 1212, */                   /* -mcpu32 */
  OPT_mcpu_ = 1213,                          /* -mcpu= */
  OPT_mcrt_ = 1214,                          /* -mcrt= */
  OPT_mdiv = 1215,                           /* -mdiv */
  OPT_mfidoa = 1216,                         /* -mfidoa */
  OPT_mhard_float = 1217,                    /* -mhard-float */
  OPT_mid_shared_library = 1218,             /* -mid-shared-library */
  OPT_mnobitfield = 1219,                    /* -mnobitfield */
  OPT_mnortd = 1220,                         /* -mnortd */
  OPT_mnoshort = 1221,                       /* -mnoshort */
  OPT_mpcrel = 1222,                         /* -mpcrel */
  /* OPT_mregparm = 1223, */                 /* -mregparm */
  OPT_mregparm_ = 1224,                      /* -mregparm= */
  OPT_mrestore_a4 = 1225,                    /* -mrestore-a4 */
  OPT_mretfp0 = 1226,                        /* -mretfp0 */
  OPT_mrtd = 1227,                           /* -mrtd */
  OPT_msasregparm = 1228,                    /* -msasregparm */
  OPT_msep_data = 1229,                      /* -msep-data */
  OPT_mshared_library_id_ = 1230,            /* -mshared-library-id= */
  OPT_mshort = 1231,                         /* -mshort */
  OPT_msmall_code = 1232,                    /* -msmall-code */
  OPT_msoft_float = 1233,                    /* -msoft-float */
  OPT_mstrict_align = 1234,                  /* -mstrict-align */
  OPT_mtune_ = 1235,                         /* -mtune= */
  OPT_mxgot = 1236,                          /* -mxgot */
  OPT_mxtls = 1237,                          /* -mxtls */
  OPT_n = 1238,                              /* -n */
  OPT_no_canonical_prefixes = 1239,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1240,              /* -no-integrated-cpp */
  OPT_no_pie = 1241,                         /* -no-pie */
  OPT_nocpp = 1242,                          /* -nocpp */
  OPT_nodefaultlibs = 1243,                  /* -nodefaultlibs */
  OPT_noixemul = 1244,                       /* -noixemul */
  ...
  OPT_pthread = 1268,                        /* -pthread */
  OPT_quiet = 1269,                          /* -quiet */
  OPT_r = 1270,                              /* -r */
  OPT_ramiga_dev = 1271,                     /* -ramiga-dev */
  OPT_ramiga_lib = 1272,                     /* -ramiga-lib */
  OPT_ramiga_libr = 1273,                    /* -ramiga-libr */
  OPT_remap = 1274,                          /* -remap */
  OPT_resident = 1275,                       /* -resident */
  OPT_resident32 = 1276,                     /* -resident32 */
  OPT_s = 1277,                              /* -s */
  OPT_s_bc_abi = 1278,                       /* -s-bc-abi */
  OPT_save_temps = 1279,                     /* -save-temps */
  OPT_save_temps_ = 1280,                    /* -save-temps= */
  OPT_shared = 1281,                         /* -shared */
  OPT_shared_libgcc = 1282,                  /* -shared-libgcc */
  /* OPT_specs = 1283, */                    /* -specs */
  OPT_specs_ = 1284,                         /* -specs= */
  OPT_static = 1285,                         /* -static */
  OPT_static_libasan = 1286,                 /* -static-libasan */
  OPT_static_libgcc = 1287,                  /* -static-libgcc */
  OPT_static_libgcj = 1288,                  /* -static-libgcj */
